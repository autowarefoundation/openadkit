...
| `ARCHITECTURE_TYPE`     | `awf/universe/20250130`                                                                                                                                         | Any valid architecture type | The architecture type to use for the scenario simulation                                                                             |
...
| `LAUNCH_RVIZ`           | `false`                                                                                                                                                         | `true`, `false`             | Set to `true` to launch RViz for the scenario simulation                                                                             |
| `LAUNCH_VISUALIZATION`  | `true`                                                                                                                                                          | `true`, `false`             | Set to `false` when using an external visualizer such as the Open AD Kit visualizer container                                        |
| `USE_CUSTOM_CENTERLINE` | `true`                                                                                                                                                          | `true`, `false`             | Whether to use custom centerline for the scenario simulation                                                                         |
...
| `GLOBAL_TIMEOUT`        | `180`                                                                                                                                                           | Any positive integer        | The timeout of the scenario simulation                                                                                               |
